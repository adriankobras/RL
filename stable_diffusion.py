...
lmain = tk.Label(height=512, width=512)
lmain.place(x=10, y=110)

modelid = "CompVis/stable-diffusion-v1-4"
device = "mps"
pipe = StableDiffusionPipeline(modelid, revision="fp16", torch_dtype=torch.float16, use_auth_token=True, auth_token=AuthToken())
pipe.to(device)
